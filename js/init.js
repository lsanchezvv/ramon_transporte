...
const mobileToggleEnButton = document.getElementById('toggle-en-mobile');
const mobileToggleEsButton = document.getElementById('toggle-es-mobile');
...
function languageToggler (lang, isMobile = false) {
  ...
  if (lang !== 'en') {
    contentToDisplay = esContent
    contentToHide = enContent
  }
  ...
  for (let i = 0; i < contentToHide.length; i++) {
    contentToHide[i].style.display = 'none';
  }
